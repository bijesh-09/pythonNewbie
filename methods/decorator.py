...
# this is ref to wrapper fn, not the original get_ice_cream fn. <function add_sprinkles.<locals>.wrapper at 0x7f8c8c8c8c8c>
print(get_ice_cream)
print()
get_ice_cream(flavor="vanilla") #calling the wrapper fn
print()
# all those process is equivalent to:
# equivalent to @add_sprinkles above, but more explicit.
# add_sprinkles(add_fudge(get_ice_cream))(flavor="chocolate")
